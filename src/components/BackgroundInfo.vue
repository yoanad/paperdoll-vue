<template>
    ...
    <h1 class="title is-spaced">Information and background of the project</h1>
    <p class="subtitle is-3">Idea</p>
    <p class="">
    ...
    <h3 class="subtitle is-3">The Data</h3>
    <p class="">
        Lorem ipsum
    </p>
    <h3 class="subtitle is-3">The Technologies</h3>
    <p class="">
        Lorem ipsum
    </p>
